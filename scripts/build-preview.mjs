...
const buildFile = resolve(root, 'android/app/build.gradle');
...
copyFileSync(resolve(root, 'android/app/build/outputs/apk/release/app-release.apk'), resolve(root, 'artifacts/SeekerTag-preview.apk'));
