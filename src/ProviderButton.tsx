...
export function ProviderMark({ provider, color = C.onPrimary }: { provider: Provider; color?: string }) {
  if (provider === 'apple') return <Ionicons name="logo-apple" color="#FFFFFF" size={23} />;
