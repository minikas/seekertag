...
**[▶ Watch the 19.8-second vertical promo](https://github.com/minikas/seekertag/releases/download/v1.0.0-clock-in/seekertag-promo-en-vertical.mp4)** — 1080×1920 for Reels, Shorts and Stories, with short English text, music and message sounds, no voiceover, and a lost-backpack story told through current app footage and the SKR devnet return. [Promo source and subtitles](presentation/video/promo/README.md).
